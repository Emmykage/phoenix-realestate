...
const Shangai = () => {
  ...
  <div className="container">
    <h1 className='bg-gray-dark-trans p-2'>Shangai</h1>
...
<section className="module">
  <div className="container">
    ...
    <span className="property-count left">{shangaiCategory.length} properties found</span>
