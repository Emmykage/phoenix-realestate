  ...
  return (
    <>
      ...
      <div className='mt-10 flex justify-between'>
        ...
        <h2 className='my-10 text-4xl font-semibold'>Withdrawal Transactions</h2>
    ...
    <div className="max-w-7xl mx-auto p-6 bg-white shadow-lg rounded-xl">
      <h2 className="text-xl font-bold mb-4">Withdrawal List</h2>
      ...
      <table className="w-full text-left border-collapse">
        ...
        <tbody>
          {loading ? <tr> 
           ...
           </tr> : transactions.length > 0 ?  transactions.map((transaction, index) => (
