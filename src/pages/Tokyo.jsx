...
const Tokyo = () => {
  ...
  const tokyoCategory = offers.filter((asset) => asset.city == "Tokyo")
  ...
  <div className="container">
    <h1 className='bg-gray-dark-trans p-2'>Tokyo</h1>
...
<section className="module">
  <div className="container">
    ...
    <span className="property-count left">{tokyoCategory.length} properties found</span>
	...
	{/* <div className="pagination">
        <div className="center">
            <ul>
              <li><a href="#" className="button small grey"><i className="fa fa-angle-left"></i></a></li>
              <li className="current"><a href="#" className="button small grey">1</a></li>
              <li><a href="#" className="button small grey">2</a></li>
              <li><a href="#" className="button small grey">3</a></li>
              <li><a href="#" className="button small grey"><i className="fa fa-angle-right"></i></a></li>
            </ul>
        </div>
        <div className="clear"></div>
    </div> */}
