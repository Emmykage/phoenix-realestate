...
const Dubai = () => {
  ...
  const dubaiCategory = offers.filter((asset) => asset.city == "dubai")
...
<section className="module">
  <div className="container">
    ...
    <span className="property-count left">{dubaiCategory.length} properties found</span>
