...
const UnitedKingdom = () => {
  ...
  <div class="container">
    <h1 className='bg-gray-dark-trans p-2'>United Kingdom Grid</h1>
...
<section class="module">
  <div class="container">
    ...
    <span class="property-count left">{unitedKingdomCategory.length} properties found</span>
    ...
    <div class="row">
    {unitedKingdomCategory.map((asset) => (
