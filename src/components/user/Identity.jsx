...
const Identity = () => {
  ...
  return (
            ...
            <form action="#" method="POST" className="sm:mt-2">
                ...
                <div className='flex flex-col md:flex-row gap-x-8 text-left my-3 text-gray-500'>
                    ...
                    <div className="flex-1 sm:col-span-2">
                        ...
                        <div className="mt-1">
                            <input type="text" value={user?.phone_no} disabled name="phone_no" id="phone_no" autocomplete="phone_no" className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-400 sm:text-sm sm:leading-6"/>
                        </div>
                    </div>
    ...
    <div className="mt-10">
      <button disabled type="submit" className="block w-max m-auto rounded-md bg-green-700 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">SUBMIT</button>
    </div>
  </form>
</div>
    </div>
